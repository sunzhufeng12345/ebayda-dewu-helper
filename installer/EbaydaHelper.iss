...
Source: "..\配置文件\*"; DestDir: "{app}\配置文件"; Excludes: ".DS_Store,*.pyc"; Flags: recursesubdirs createallsubdirs onlyifdoesntexist uninsneveruninstall skipifsourcedoesntexist
